...
const Dashboard = () => {
  ...
  async function getAllUsers(page = 0, query = "", limit = 10, appStatus = "") {
    ...
    await axiosInstance
      .get(
        `api/users/all-users?pageNumber=${page}&limit=${limit}&filterApplicationStatus=${appStatus}&filterSearch=${query}`
      )
      .then((res) => {
    ...
    <section>
      ...
      <div className="mt-5 h-full">
        <div className="grid grid-cols-1 gap-5 md:grid-cols-4">
          <div
            className="cursor-pointer rounded-md bg-green-500  p-10 duration-200 hover:shadow-xl"
          ...
          <div
            className="cursor-pointer rounded-md bg-orange-500  p-10 duration-200 hover:shadow-xl"
          ...
          <div
            className="cursor-pointer rounded-md bg-red-500  p-10 duration-200 hover:shadow-xl"
            onClick={() => navigate("/admin-dashboard/dues")}
          >
          ...
          <div
            className="cursor-pointer rounded-md bg-yellow-400  p-10 duration-200 hover:shadow-xl"
            onClick={() => navigate("/admin-dashboard/dues")}
          >
